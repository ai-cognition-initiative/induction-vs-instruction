...
**Why study this?** Modern LLMs are shaped by two objectives installed at different phases of training, and in most situations they work in tandem:
...
Across 13 models and 16 instructions, average IF ranges from 1% to 99% across models, the transition from instruction- to pattern-following is universal but highly model-dependent, and output diversity — not semantic engagement with the input — is the primary factor predicting robustness.
