...
CONDITIONS: dict[str, Condition] = {
    ...
    "variety_geography_animals": Condition(
        ...
        target_description="write 1-3 sentences about a random animal",
        pattern_description="write 1-3 sentences about a random geography topic",
    ...
    "variety_animals_geography": Condition(
        ...
        target_description="write 1-3 sentences about a random geography topic",
        pattern_description="write 1-3 sentences about a random animal",
        condition_type="variety",
        scorer_type="llm_judge",
        pattern_data_key="variety_animals",
    ),
    # --- Classify fixed (task engagement with single-token output) ---
    "classify_sh_economics": Condition(
        name="classify_sh_economics",
        pattern="economics",
